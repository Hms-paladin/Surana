...
import tableschema from '../DesignApplication/DesignAppSchema.json';
import PatentTable from '../../Patent/PatentApplication/PatentTable/DynTable'
...
class DesignRectificationDefendList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      userdata: null,
...
export default DesignRectificationDefendList;