...
class AddProjectDynTable extends Component {
  constructor(props) {
    super(props);
    this.state = {
      order:'asc',
  ...
  deleterow=(data)=> {
    console.log(data,"deleterowdata")
    ...
    <div className="heading_left" >
      ...
      headprops={this.props.tablehead}
        ...
        <div className="tableWrapper">
                    ...
                    >
                     ...
                     <TableCell align="left" >
                      ...
                      <TableCell align="left" style={{paddingLeft:"10px"}}>{
                        ...
                        onClick={(e)=>this.opendeletemodel(row,row.id)}
                        />
                        </Tooltip>
                        }
                        </div>
          ...
          // style={"width: 520px !important; transform-origin: 807px 288px;"}
          modelclassName={"nonebtnmodel expense_table_Modal"}
          />
          :null}
...
export default withStyles(styles)(AddProjectDynTable);