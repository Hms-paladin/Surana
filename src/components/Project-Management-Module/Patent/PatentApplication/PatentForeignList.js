...
import tableschema from './PatentAppSchema.json';
import PatentTable from './PatentTable/DynTable';
...
class PatentForeignList extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      userdata: null,
...
export default PatentForeignList;