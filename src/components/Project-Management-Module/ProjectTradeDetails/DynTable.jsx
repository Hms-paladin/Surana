  ...
  return (
    ...
    <div className="heading_left" >
      ...
      headprops={this.props.tablehead}
         /> */}
        <div className="tableWrapper projecttemplate_table">
          <Table
            className="table"
                    ...
                    >
                      ...
                      {[row].map(((data,index)=>{
                          ...
                          for(var m=0;m<keys.length-2;m++){
                            arrval.push(<TableCell key={data.id+""+m} className="intercell">{data[keys[m]]}</TableCell>)
                          }
                          return arrval
                        })
                        )}
                      ...
                      <TableCell align="left" >
                        ...
                        onClick={(e)=>this.props.viewopen({rowId:row.id,trademark:row.trademark})}
                        />
                        }
                        </div>
                      </TableCell>
                      <TableCell align="left" style={{paddingLeft:"10px"}}>{
                        ...
                        onClick={(e)=>this.props.editOpen({rowId:row.id,trademark:row.trademark})}
                        />
                        </Tooltip>}
