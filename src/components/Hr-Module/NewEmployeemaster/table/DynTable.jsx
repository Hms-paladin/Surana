...
class EmployeeTable extends Component {
  ...
  viewopen=(data)=>{
    // this.getemployeeofficial(data.id);
    ...
    axios({
      ...
      this.setState({
        viewdata:data,
        viewmodel:true,
        employeeOfficial:response.data.data.filter((alldata)=>{return alldata.EmpId===data.EmpId })[0]
      })
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell className="empMaster_tablecell">
                        {/* {Object.keys(this.state.row)[index]} */}
...
{/* 
          ...
          employeeOfficial={this.state.employeeOfficial}
