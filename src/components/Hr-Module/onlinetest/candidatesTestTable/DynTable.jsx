...
import MyVerticallyCenteredModal from '../../create_resume/Sendemail';
...
class CandidatesTestTable extends Component {
  constructor(props) {
    super(props);
    this.state = {
      order: 'asc',
...
export default withStyles(styles)(CandidatesTestTable);