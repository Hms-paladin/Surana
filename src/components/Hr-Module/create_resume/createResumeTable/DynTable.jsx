...
import { getResumeDetails, resumeIdTable } from '../action/CreateResumeAction';
const { confirm } = Modal;
const { Search } = Input;
...
class CandidateDynTable extends Component {
  ...
  handleClick = (event, id) => {
    ...
    if (selectedIndex === -1) {
      ...
      console.log(newSelected, "newSelected2")
    ...
    // if(newSelected && id){
    //   console.log("selected",newSelected && id)
    // }
    this.setState({ selected: newSelected });
    console.log("newSelectedend", this.state.selected)
  ...
  deleterow = (data) => {
    console.log(this.state.selected, "deleterow")
  ...
  editOpenToResume = (data) => {
    this.props.dispatch(resumeIdTable(data.resume))
    this.props.dispatch(getResumeDetails(data.resume,this.props.propFunc))
    this.props.editTabControl(0, true)
  }
  render() {
    console.log(this.state.selected, "selectedrowdata")
                      ...
                      .map((row, index) => {
                        ...
                        {this.state.rowsPerPage * this.state.page -1 +index +2}
                            ...
                            <TableCell align="left" className="Createres_tablecell">
                              <EditIcon className="sethover_background mr-2" onClick={() => this.editOpenToResume(row)} />
                              {/* <Tooltip title="Edit" placement="right" enterDelay={300}>
                              </Tooltip> */}
