...
import './knowledgeDynTable.css';
import dateFormat from 'dateformat';
import Modalreact from "../../../table/viewmodel"
import { Input } from 'antd';
import { Modal } from 'antd';
import Deletemodal from '../../../table/deletemodel';
...
class KnowledgeDynTable extends Component {
  constructor(props) {
    super(props);
    this.state = {
      order:'asc',
          ...
          console.log(data,"insidemapviewdata")
           ...
           viewdata.push(
            <div className="d-flex">
              ...
              <div>
                <div>{data.Title}</div>
                <div>{data.KnowTags.replace('[',"").replace("]","").replace(/"/g,"")}</div>
  ...
  pdfdownload=(pdfurl)=>{
    ...
    if(pdfurl===null){
      alert("PDF not inserted")
    }else{
    window.open("http://54.198.55.249/suranauploads/KnowDocument_124_dummy.pdf")
    }
  }
...
render(){
  console.log(this.state.viewdata,"rowdata")
  ...
  return (
    ...
    <div className="heading_left heading_leftknowledge" >
      ...
      headprops={this.props.tablehead}
        ...
        <div className="tableWrapper">
                    ...
                    >
                     ...
                     <TableCell align="left" >
                      <Tooltip title="view" placement="right" enterDelay={300}>
                        ...
                        <GetAppIcon className="pdfdownload_clr" onClick={()=>this.pdfdownload(row.url)} />
                      </TableCell>
          ...
          viewdata={this.state.viewdata[0]}
...
export default withStyles(styles)(KnowledgeDynTable);