...
// class ManagingAppraisal extends React.Component{
//     render(){
//         return(
//             <p>dsesec</p>
//         )
...
import '../../hodTab/appraisalhod/AppraisalHod.css'
                            ...
                            <div className="newUser_heading_hod">Suggestions, If any for improvement at SSIA</div>
                             ...
                             <Grid item md={12} sm={5}>
                              ...
                              <Grid container direction="row" justify="center"  alignItems="center"  className="mt-3" spacing={3}>
                                <Grid item >
                                   <Button className="btnwidth btnclr">Back</Button>
                                </Grid>
...
export default ManagingAppraisal;