...
//       <table>
//         <tr>
//           <th className="Dayreport_th">Intern Name</th>
//           <th className="Dayreport_th">Application Date</th>
//           <th className="Dayreport_th">Application No</th>
//           <th className="Dayreport_th">Details</th>
//         </tr>
//         <tr>
//           <td style={{padding:"0px 0px 0px 25px"}}>Interim Relief</td>
//           <td>31 Mar 2020</td>
//           <td>01345</td>
//           <td>-</td>
//         </tr>
...
//     <div className={`margin_left ${this.props.mainclassName}`} style={{marginTop:"1%"}}>
//     <div className="heading_left dayreport_tablemain" >
...
//                         return(
//                           <TableCell key ={key} onClick={()=>this.checkdata(index)}>
...
//                       <Tooltip title="view" placement="right" enterDelay={300}>
//                         <VisibilityIcon className="sethover_background" 
//                         onClick={this.props.viewopen}
//                         // onClick={()=>this.viewopen(index)}
//                         />
//                         </Tooltip>
//                       </TableCell>
//                       <TableCell align="left" style={{paddingLeft:"10px"}}>{
...
//                             {this.state.viewdata === index ? CollapseData : ""}
//                       </TableCell>
//                       </TableRow>
//                       </>
//                   );
