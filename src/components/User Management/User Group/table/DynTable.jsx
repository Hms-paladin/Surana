...
import ReactModal from "../Usergroupmodal"
...
class DynTable extends Component {
  ...
  addgroupopen = (data) => {
    const editData = this.props.tabledata && this.props.tabledata.find(value => value.id === data)

    console.log("asdfjhsadfkhsaf", editData)
  ...
  render() {
    ...
    console.log(this.state, 'asdfsdfsdfsf')
          ...
          <div className="heading_left" >
            ...
            <Paper className="paper">
              ...
              <div className="tableWrapper">
                                  ...
                                  {this.props.editclose === "editicon" ? null :
                                    <Tooltip title="Edit" placement="left" enterDelay={300}>
                                      <EditIcon className="sethover_background"
                                        onClick={(e) => this.addgroupopen(row.id, row)}
                                      />
                                    </Tooltip>}
                ...
                {this.state.addusergroup ?
                  <ReactModal
                    visible={true}
                    edit={true}
                    onclickok={this.setviemodelfalse}
                    editData={this.state.editData}
                    getUserGroup={() => this.props.getUserGroup()}
                ...
                {this.state.opendelete ?
                  <Deletemodal
                    ...
                    deleteId={this.state.onclickdata}
