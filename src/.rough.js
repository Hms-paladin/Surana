              ...
              Mini variant drawer
                ...
                >
                    ...
                    <MenuList className="menu_background_clr">
                        ...
                        {/* Hr Module - One*/}
                        { dashboardView || resumeView || recruiteView || questionView || onlineTestView || interviewView || empMasterView || KRAView || KPIView || AppraisalView || leaveAppView || severanceView || requirementTicketView || selCandidateView && <>
...
{/* Employee Appraisal end*/}
                        ...
                        { projectView || ipStageView || trademarkView || designView || patentView || copyrightView || ipProjectView && <>
                        ...
                        { courtView || caseView || dayreportView && <>
                        ...
                        { timeSheetView || expenseView || unblockUserView || <React.Fragment>
